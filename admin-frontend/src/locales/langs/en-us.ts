const local: App.I18n.Schema = {
  ...
  route: {
    ...
    function: 'Operations',
    alova: 'Models & Agents',
    alova_request: 'Model Services',
    alova_scenes: 'Agent Orchestration',
    ...
    function_request: 'Runtime Logs',
    'function_toggle-auth': 'System Settings',
    ...
    exception_404: '404',
    exception_500: '500',
    plugin: 'Content Governance',
    plugin_copy: 'Prompt Templates',
