# Soybean Admin frontend handoff

This package targets Soybean Admin. The official Soybean Admin frontend source is not yet in this repository; backend APIs and handoff materials are frozen for integration.
